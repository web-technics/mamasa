...
New-OgImage -OutputFile (Join-Path $imagesPath 'og-restaurant.png') -BackgroundImage (Join-Path $imagesPath 'og-restaurant.jpg') -Kicker 'Toproof Restaurant' -Title 'Authentic Khmer Dining With A View' -Subtitle 'Panoramic Kampot dining, local dishes, and a rooftop setting made for sunset meals and relaxed evenings.' -Accent '#C4A962'
